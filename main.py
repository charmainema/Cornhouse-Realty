        ...
        "character": [
            [["Aha, you've brought me the cornmeal. I can",
              ...
              ["The more eggs you bid, the more likely we are",
                ...
                "you will need at least 50 eggs to succeed."],
        ...
        class world4:
            class graphics:
                ...
                def render_opening_screen():
                    if game.world.world4.mechanics.enter_count == 0:
                        ...
                        game.world.world4.graphics.render_opening_text("To win the bid, you must earn 100 EGGS by catching 50 corn.", WHITE, 20, 280)
            ...
            class mechanics:
                ...
                class win_loss:
                    ...
                    def handle_win_loss():
                        if game.world.world4.mechanics.egg_count == 50:
